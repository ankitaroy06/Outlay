...
<body>
  ...
  <!--Body-->
  <div class="bodyMain">
    <div class="bodyB-index">
      <span>We help you control your budget.</span>
      <button type="button" class="btn btn-lg index-button btn-light kButton"><a href="logIn.php">Start Today</a></button>
    </div>
  </div>
