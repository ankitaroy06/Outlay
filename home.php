...
<body>
  ...
  <!--Home Body-->
  <div class="bodyMain homebody" style="background-color: #00000026;">

    <h1 class="container">You don't have any active plans.</h1>
    <div class="card addPlan">
      <a href="createNewPlan.php"><i class="fa">&#xf0fe;</i> Create New Plan</a>
    </div>
  </div>
